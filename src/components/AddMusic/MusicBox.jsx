...
const MusicBox = ({item, color, playlistInfo, setPlaylistInfo, sendAlert}) => {
    ...
    return (
        <S.MusicBox color={color}>
            ...
            <S.MusicInfoText color="#202F61" right="200px">{getDate(item.date)}</S.MusicInfoText>
            <S.MusicInfoText color="#202F61" right="90px">{item.views.toLocaleString('ko-KR')}회</S.MusicInfoText>
