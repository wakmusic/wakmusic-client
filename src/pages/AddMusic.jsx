    ...
    return (
        <S.Container>
            ...
            <S.MainFindInputBox>
                    ...
                    {menuBool && (
                        <S.FilterMenu>
                            {findCategory.map((item, index) => {
                                return (
                                    <S.Menu name={index} onClick={handleOnChangeSelectValue}
                                            key={index}>{item.name}</S.Menu>
                                );
                            })}
                        </S.FilterMenu>
                    )}
                ...
                <S.FindInput onChange={onChangeKeyword} placeholder="검색어를 입력해 주세요."/>
                <S.FindIcon src={FindIcon}/>
            </S.MainFindInputBox>
            <S.appendMusicLayout>
                <S.MusicFilterLayout>
                    <S.DropdownLayout><Dropdown setType={setSort} setData={setMusicList}
                                                elements={SortTypeList}/></S.DropdownLayout>
                    <S.UpdateText><UpdateTime type="total"/></S.UpdateText>
                </S.MusicFilterLayout>
                <S.MusicInfoBox>
                    <S.MusicInfoName>곡정보</S.MusicInfoName>
                    <S.MusicInfoText color="#080F34" right="95px">조회수</S.MusicInfoText>
                    <S.MusicInfoText color="#080F34" right="205px">출시일</S.MusicInfoText>
                </S.MusicInfoBox>
